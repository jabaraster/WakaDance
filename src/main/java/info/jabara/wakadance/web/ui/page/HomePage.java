 ...
 * 
 */
package info.jabara.wakadance.web.ui.page;

import info.jabara.wakadance.entity.EEmployee;
import info.jabara.wakadance.entity.EEmployee_;
...
public class HomePage extends WebPageBase {
    ...
    /**
     * @see info.jabara.wakadance.web.ui.page.WebPageBase#renderHead(org.apache.wicket.markup.head.IHeaderResponse)
     */
    @Override
