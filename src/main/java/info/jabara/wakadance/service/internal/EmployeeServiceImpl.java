...
public class EmployeeServiceImpl extends JpaDaoBase implements EmployeeService {
    ...
    /**
     * @see info.jabara.wakadance.service.EmployeeService#delete(info.jabara.wakadance.entity.EEmployee)
     */
    @Transactional
    @Override
    ...
    /**
     * @see info.jabara.wakadance.service.EmployeeService#getAll()
     */
    @Override
    ...
    /**
     * @see info.jabara.wakadance.service.EmployeeService#insert(java.lang.String)
     */
    @Transactional
    @Override
